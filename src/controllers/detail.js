...
const data = [
    ...
    },
    {
        ...
        description: [
            ...
            { 
                sub: "ข้อมูลที่ผู้ใช้ป้อนเข้ามาไม่ได้รับการตรวจสอบ ความสะอาด (Sanitize) หรือกรองอย่างเหมาะสม", 
                img: "" 
            },
            { 
                sub: "ใช้คำสั่งแบบไดนามิก (Dynamic Queries) หรือคำสั่งที่ไม่ใช่พารามิเตอร์ (Non-Parameterized Calls) โดยไม่มีการหลีกเลี่ยงอักขระที่ไม่ปลอดภัยตามบริบท (Context-Aware Escaping) ก่อนส่งให้ตัวแปลคำสั่ง",
                img: "" 
            },
            { 
                sub: "ข้อมูลที่เป็นอันตรายถูกใช้ในพารามิเตอร์การค้นหาของ Object-Relational Mapping (ORM) เพื่อดึงข้อมูลที่สำคัญเพิ่มเติม",
                img: "" 
            },
            { 
                sub: "ข้อมูลที่เป็นอันตรายถูกนำไปใช้หรือรวมเข้ากับคำสั่ง SQL หรือคำสั่งอื่น ๆ โดยตรง ซึ่งคำสั่งนั้นมีทั้งโครงสร้างและข้อมูลที่เป็นอันตรายในรูปแบบของ Query ไดนามิก คำสั่ง หรือ Stored Procedure",
                img: "" 
            },
            { 
                sub: "การโจมตีแบบ Injection ที่พบบ่อย ได้แก่ SQL, NoSQL, OS Command, Object Relational Mapping (ORM), LDAP, และ Expression Language (EL) หรือ Object Graph Navigation Library (OGNL) ซึ่งมีหลักการเหมือนกันในทุกตัวแปลคำสั่ง การรีวิวซอร์สโค้ดเป็นวิธีที่ดีที่สุดในการตรวจจับช่องโหว่เหล่านี้ และควรทดสอบข้อมูลที่ป้อนเข้ามาทั้งหมด เช่น พารามิเตอร์, Header, URL, Cookie, JSON, SOAP, และ XML ด้วยวิธีอัตโนมัติ นอกจากนี้ องค์กรสามารถนำเครื่องมือทดสอบความปลอดภัย เช่น SAST, DAST และ IAST เข้ามาใช้ในกระบวนการ CI/CD เพื่อป้องกันไม่ให้ช่องโหว่ถูกส่งไปยังระบบจริงก่อนการใช้งาน",
                img: "" 
            },
        ],
        HowtoPrevent: [
